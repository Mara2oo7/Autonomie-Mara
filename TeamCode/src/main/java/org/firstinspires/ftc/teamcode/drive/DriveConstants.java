...
public class DriveConstants {
    ...
    public static final RevHubOrientationOnRobot.UsbFacingDirection USB_FACING_DIR = FORWARD;
    ...
    public static double MAX_ANG_VEL = Math.toRadians(201.006);
    public static double MAX_ANG_ACCEL = Math.toRadians(201.006);
